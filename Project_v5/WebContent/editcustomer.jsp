...
<div class="form-customer w-100 border p-4 mx-auto">
    <form class="row" name="customerForm" method=post action="updateCustomer.jsp">
        ...
        <div class="col-md-6">
            <div class="form-floating mb-2">
                <input name="custuserid" type="text" class="form-control" id="inputCustuserid" placeholder="User id" value="<%= cust_userid %>">
                <label for="inputCustuserid">User Id</label>
            </div>    
        </div>
        <div class="col-md-6">
            <div class="form-floating mb-2">
                <input name="custpassword" type="text" class="form-control" id="inputCustpassword" placeholder="Password" value="<%= cust_password %>">
