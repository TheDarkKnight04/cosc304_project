...
out.print (page_header (auth_userid));
...
while (rst.next()) {
    ...
    <li class="list-group-item d-flex justify-content-between align-items-start"
        <div class="ms-2 me-auto">
            <div class="fw-bold">
                <span>Rating: <%= rev_rating %> out of 5</span>
                <span>on <%= new java.util.Date(rev_date.getTime()) %> </span>
            </div>
            <p><%= rev_comment %></p>
            -- <%= rev_userid %>
        </div>
    ...
    <div class="col-md-6">
        ...
        <form name="reviewForm" method=post action="review.jsp">
            ...
            <div class="mb-3">
                ...
                <select id="review-rating" class="form-select" aria-label="Product rating">
