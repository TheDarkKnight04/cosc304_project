...
if (updemail != null) {
	...
	if (userName != null) {
		...
		out.println ("<h2 class=\"text-center mb-3\">Customer Profile For " + firstName + "</h2>");
		out.println("<form name=\"formcust\">");
		out.println ("<table class=\"table w-50 mx-auto\"><tbody>");
		out.println ("<tr><td class=\"w-50 text-right\">Id</td><td class=\"w-50 text-left\">" + custId + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">First Name</td><td class=\"w-50 text-left\">" + firstName + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Last Name</td><td class=\"w-50 text-left\">" + lastName + "</td></tr>");
		...
		//out.println ("<tr><td class=\"w-50 text-right\">Email</td><td class=\"w-50 text-left\">" + email + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Email</td><td class=\"w-50 text-left\"><input type=\"text\" name=\"newemail" +"\" size =\"20\" value=\"" + email +"\">" + "</td>");
		out.println ("<td class=\"w-50 text-right\">" + updateLink + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Phone Number</td><td class=\"w-50 text-left\">" + phoneNum + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Address</td><td class=\"w-50 text-left\">" + address + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">City</td><td class=\"w-50 text-left\">" + city + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">State</td><td class=\"w-50 text-left\">" + state + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Postal Code</td><td class=\"w-50 text-left\">" + postalCode + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">Country</td><td class=\"w-50 text-left\">" + country + "</td></tr>");
		out.println ("<tr><td class=\"w-50 text-right\">User Id</td><td class=\"w-50 text-left\">" + userName + "</td></tr>");
