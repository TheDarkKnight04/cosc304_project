...
try ( 
	...
	if (delid != null) {
        ...
        session.setAttribute ("adminMessage", "Product id: " + delid + " deleted.");
	}
	closeConnection();
}
...
<%
  ...
  out.print (doc_head ("Admin Products"));
...
<div class="container px-4">
	<form class="row g-3" method="get" action="productadmin.jsp">
		<div class="col-md-9">&nbsp;</div>
		<div class="col-md-3">
			<button type="button" class="btn btn-primary mx-auto"><a href="editproduct.jsp" style="text-decoration: none;">New Product</a></button>
		</div>
...
try ( 
	...
	while (rst.next()) {
		...
		%>
			<tr>
				<td>
					<a class="btn btn-outline-primary" href="editproduct.jsp?id=<%= productId %>">Edit</a>
					<a class="btn btn-danger" href="productadmin.jsp?delete=<%= productId %>">Delete</a>
				</td>
				<td>
					<a href="product.jsp?id=<%= productId %>"><%= productName %></a>
				</td>
				<td><%= category %></td>
